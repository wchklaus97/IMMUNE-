...
- `asset-rights-attestation-v8.6-template.md`: hash-bound R7.2/reference/key-art
  signing package, also deliberately left awaiting the authorized owner's signature;
