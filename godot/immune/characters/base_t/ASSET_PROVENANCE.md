...
- Runtime scene: `characters/base_t/character.tscn`
- Shipping mesh: `CHAR-BASE-T-tripo-5k.glb`
...
- Runtime material: the Tripo base colour is retained as a feature mask so the
  eyes, pore, and mouth remain readable; the wet-gel lighting, micro-height,
  coat, and membrane response are authored in Godot.
...
Steam build. This file records what is known; it does not invent missing rights.
